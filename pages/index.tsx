...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-5 py-4">
      <div className='flex flex-col items-center gap-[50rem]'>
        <div ref={checkpointsRefs[0]} className="flex flex-col w-full">
          <Header />
