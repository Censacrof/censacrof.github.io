...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-5 py-4">
      <div ref={checkpointsRefs[0]} className='flex flex-col items-center'>
        <Header />
